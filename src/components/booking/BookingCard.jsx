      ...
      <Card className="overflow-hidden hover:shadow-md transition-shadow">
        <CardContent className="p-4">
          <div className="flex items-start justify-between mb-3">
            ...
            <Badge className={statoBadgeColors[booking.stato] || 'bg-gray-100'}>
              {STATO_LABELS[booking.stato] || booking.stato}
            </Badge>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {booking.stato === 'confermata' && onEdit && (
                <Button variant="outline" size="sm" onClick={() => onEdit(booking)}>
                  <Pencil className="w-4 h-4" />
                </Button>
              )}
              {booking.stato === 'confermata' && onCancel && (
