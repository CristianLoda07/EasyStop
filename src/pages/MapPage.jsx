...
export default function MapPage() {
  ...
  const { data: parcheggi = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Carica le prenotazioni attive (non scadute e non cancellate)
      ...
      // Conta le prenotazioni per parcheggio
      const contatorePrenotazioni = (prenotazioni || []).reduce((acc, p) => {
        acc[p.id_park] = (acc[p.id_park] || 0) + 1;
        return acc;
      }, {});

      // Arricchisce ogni parcheggio con posti_prenotati calcolati live
