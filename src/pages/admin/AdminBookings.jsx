...
export default function AdminBookings() {
  ...
  const deleteBookingMutation = useMutation({
    mutationFn: () => base44.entities.Prenotazione.delete(deleteBooking.id),
    onSuccess: () => {
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{viewDetails.tipo_posto || '-'}</p>
                </div>
                <div>
                ...
                <div className="col-span-2">
                  ...
                  <p className="font-medium">{viewDetails.risparmio_co2 || 0} kg</p>
                </div>
